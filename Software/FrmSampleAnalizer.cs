...
namespace Sample_Analizer
{
    public partial class FrmSampleAnalizer : Form
    {
        ...
        private void btnObrisi_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult result = MessageBox.Show("Jeste li sigurni da želite Obrisati radni nalog?", "Problem", MessageBoxButtons.YesNo, MessageBoxIcon.Error);
                ...
                frmSampleAnalizer.ShowDialog();
                    MessageBox.Show("Nalog je uspješno obrisan", "Problem", MessageBoxButtons.OK);
                }
