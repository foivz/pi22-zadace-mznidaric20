...
{
    public partial class FrmSampleAnalizer2 : Form
    {
        public FrmSampleAnalizer2(string trazi)
        {
            InitializeComponent();
            TraziPokaziRadneNaloge(trazi);
        }
        public void TraziPokaziRadneNaloge(string trazi)
        {
            var radniNalozi = RadniNaloziRepository.TraziGetRadniNalozi(trazi);
